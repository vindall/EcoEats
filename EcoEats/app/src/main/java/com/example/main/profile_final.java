...
public class profile_final extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout historyGroup, ordersGroup, homeGroup;
        ...
        if (historyGroup != null) {
            historyGroup.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(profile_final.this, historyActivity.class));
        ...
        if (homeGroup != null){
            homeGroup.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(profile_final.this, home_final.class));
                    finish();
                }
            });
        }
        if (ordersGroup != null) {
            ordersGroup.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(profile_final.this, active_orders_final.class));
